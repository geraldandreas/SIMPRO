...
if (tendikList && tendikList.length > 0) {
  for (const tendik of tendikList) {
    await sendNotification(
      tendik.id,
      "Jadwal Sidang Ditetapkan",
      `Mahasiswa atas nama ${mhsName} dengan judul "${data.proposal.judul}" telah ditetapkan sidang pada tanggal ${formattedDate} pukul ${jam} WIB di ${ruangan}. Dosen penguji: ${listNamaPenguji}.`
    );
  }
}
